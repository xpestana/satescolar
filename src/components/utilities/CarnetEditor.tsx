...
const HEADER_TARGETS = ["schoolName", "city", "year", "logo"] as const;
          ...
          <CardContent className="flex justify-center">
            ...
            >
              ...
              <div className="relative overflow-hidden" style={{ height: layout.headerHeight, backgroundColor: primaryColor }}>
                ...
                {logoUrl && (
                  <div
                    className={`absolute -translate-x-1/2 -translate-y-1/2 z-10 ${ringClass("logo")} rounded`}
                    style={{ left: `${layout.logoPos.x}%`, top: `${layout.logoPos.y}%`, cursor: cursorStyle("logo") }}
